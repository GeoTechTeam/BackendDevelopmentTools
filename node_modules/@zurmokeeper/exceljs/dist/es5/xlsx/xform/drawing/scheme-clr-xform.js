  ...
  render(xmlStream, model) {
    if (model.schemeColor) {
      xmlStream.openNode(this.tag, {
        val: model.schemeColor
      });
      if (model.shade !== 0) {
        xmlStream.leafNode('a:shade', {
          val: model.shade * 100000
        });
      }
      if (model.opacity < 1) {
        xmlStream.leafNode('a:alpha', {
          val: model.opacity * 100000
        });
      }
      xmlStream.closeNode();
    }
...
//# sourceMappingURL=scheme-clr-xform.js.map
