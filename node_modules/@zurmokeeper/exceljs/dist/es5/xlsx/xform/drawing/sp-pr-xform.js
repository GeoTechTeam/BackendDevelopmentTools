...
class SpPrXform extends BaseXform {
  ...
  parseClose(name) {
    ...
    switch (name) {
      case this.tag:
        Object.assign(this.model, this.map['a:xfrm'].model ? this.map['a:xfrm'].model : null, this.map['a:prstGeom'].model ? this.map['a:prstGeom'].model : null, this.map['a:solidFill'].model ? {
          fill: this.map['a:solidFill'].model
        } : null, this.map['a:noFill'].model ? {
          fill: this.map['a:noFill'].model
        } : null, this.map['a:ln'].model ? {
          stroke: this.map['a:ln'].model
        } : null);
        return false;
      default:
        return true;
